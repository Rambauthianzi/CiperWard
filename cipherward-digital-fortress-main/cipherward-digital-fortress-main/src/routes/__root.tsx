...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Advanced cybersecurity solutions that safeguard businesses from evolving cyber threats through intelligent defense, proactive monitoring, and trusted expertise." },
      { name: "author", content: "CipherWard Technologies" },
      { property: "og:title", content: "CipherWard Technologies — Encrypt. Defend. Secure." },
